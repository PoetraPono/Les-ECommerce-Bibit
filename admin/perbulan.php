...
<body>
    <div class="container">
        ...
        <br>
        <h3 class="col-sm-12" align="center"><u>Laporan Data Produk Bulan Ke- <?php echo $bln[1]  ?></u></h3>
        <br>
        <br>
        <br>
        <div class="row">
                    ...
                    <table class="table table-striped table-hover table-bordered">
                        ...
                        <tbody>
                            ...
                            *
                            ...
                            db_batik.tb_ongkir ON db_batik.tb_pembelian.ongkir_id = db_batik.tb_ongkir.ongkir_id WHERE tb_pembelian.pembelian_tgl LIKE '$bulan%'");
